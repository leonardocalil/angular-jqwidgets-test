...
export class AppComponent {
  ...
  public sourceLeo: jqwidgets.GridSource = {
    localdata: [
    ...
    datafields: [
        { name: 'City', type: 'string', map: '0' },
        { name: 'State', type: 'string', map: '1' },
        { name: 'Country', type: 'string', map: '2' }
    ],
    datatype: 'array'
  };

  public dataAdapterLeo = new jqx.dataAdapter(this.sourceLeo);

  public columnsLeo: jqwidgets.GridColumn[] = [
    { text: 'City', datafield: 'City', width: 240 },
    { text: 'State', datafield: 'State', width: 240 },
